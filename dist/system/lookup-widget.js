System.register(['aurelia-templating', 'aurelia-binding', 'aurelia-dependency-injection', 'jquery', 'select2'], function (_export) {
  'use strict';

  var customElement, bindable, bindingMode, inject, $, select2, LookupWidget;
